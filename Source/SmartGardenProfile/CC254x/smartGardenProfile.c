...
{ 
  LO_UINT16(SMARTGARDEN_SERV_UUID), HI_UINT16(SMARTGARDEN_SERV_UUID)
};

// Characteristic 1 UUID: 0xFFF1
CONST uint8 simpleProfilechar1UUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SMARTGARDEN_CHAR1_UUID), HI_UINT16(SMARTGARDEN_CHAR1_UUID)
};

// Characteristic 2 UUID: 0xFFF2
CONST uint8 simpleProfilechar2UUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SMARTGARDEN_CHAR2_UUID), HI_UINT16(SMARTGARDEN_CHAR2_UUID)
};

// Characteristic 3 UUID: 0xFFF3
CONST uint8 simpleProfilechar3UUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SMARTGARDEN_CHAR3_UUID), HI_UINT16(SMARTGARDEN_CHAR3_UUID)
};
...
static uint8 simpleProfileChar1UserDesp[16] = "Battery voltage";
...
static uint8 simpleProfileChar2UserDesp[16] = "Moisture sensor";
...
static uint8 simpleProfileChar3UserDesp[18] = "Luminosity sensor";
                                           ...
                                           uint8 maxLen, uint8 method )
{
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      case SMARTGARDEN_CHAR1_UUID:
        *pLen = 2;
        *((uint16*)pValue) = *((uint16*)pAttr->pValue);
        break;
      case SMARTGARDEN_CHAR2_UUID:
        *pLen = 2;
        *((uint16*)pValue) = *((uint16*)pAttr->pValue);
        break;
      case SMARTGARDEN_CHAR3_UUID:
        *pLen = 2;
        *((uint16*)pValue) = *((uint16*)pAttr->pValue);
        break;
