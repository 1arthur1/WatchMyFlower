...
// Profile Parameters
#define SIMPLEPROFILE_CHAR1                   0  // RW uint16 - Battery voltage value
#define SIMPLEPROFILE_CHAR2                   1  // RW uint16 - Moisture sensor value
#define SIMPLEPROFILE_CHAR3                   2  // RW uint16 - Luminosity level value
